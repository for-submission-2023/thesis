"""
Instrument Segmentation Dataset (MedAI 2021)

Binary segmentation: background (0), instrument (1)
"""
...
class InstrumentDataset(Dataset):
    """
    MedAI 2021 Instrument Segmentation Dataset.
    Same structure as NoraDataset in instrument.py
