...
def train(model, optimizer, num_classes, train_loader=None, valid_loader=None,
          valid_data=None, epochs=100, device='cpu', label_dict=None, poly_lr=False):
    ...
    for epoch in tqdm(range(1, epochs + 1)):
        ...
        # evaluate() handles its own no_grad internally
        mean_dice = evaluate(dataset=valid_data, model=model, num_classes=num_classes, device=device, label_dict=label_dict)
