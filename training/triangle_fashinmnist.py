...
UNETR_ViT_DEPTH  = None  # set manually
...
train_dataset = FashionMNISTDataset(
    ...
    include_label=INCLUDE_LABEL, length=LENGTH, jitter=JITTER,
)
valid_dataset = FashionMNISTDataset(
    dataset=_valid_raw, transform=valid_transform, shape=IMG_SIZE,
    labels=LABELS, not_labels=NOT_LABELS, background_obj=BACKGROUND_OBJ,
    include_label=INCLUDE_LABEL, length=LENGTH // 2, jitter=JITTER,
)
...
models_config = [
    ...
    #     'model_path':    f'{SAVED}/trianlge_fashionmnist_224_0_noise_unetr_vit_d2_upsampled_dice0_96_epoch48.pth',
    #     'train_model':   True,
    #     'evaluate_only': False,
    # },
    # {
    #     'name':          f'UNETR-ViT-D3-Direct',
    #     'model':         UNETR_ViT(num_classes=NUM_CLASSES, depth=3, pretrained=True, direct_upsample=True),
    #     'model_path':    f'{SAVED}/trianlge_fashionmnist_224_0_noise_unetr_vit_d3_upsampled_dice0_75_epoch14.pth',
    #     'train_model':   True,
    #     'evaluate_only': False,
    # },
