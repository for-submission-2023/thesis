...
BASE = '/home/litisnouman/Desktop/Thesis_18_02_26/datasets/Polyp/MedAI_2021_Polyp_Segmentation_Development_Dataset'

images_paths = [os.path.join(BASE, 'images', i) for i in os.listdir(os.path.join(BASE, 'images'))]
masks_paths  = [i.replace('images', 'masks') for i in images_paths]
...
train_dataset = PolypDataset(train_images, train_masks, transform=train_transform, return_path=False)
valid_dataset = PolypDataset(valid_images, valid_masks, transform=valid_transform, return_path=False)
