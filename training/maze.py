...
from datasets import BinaryMazeDataset
...
GRID_SIZE = 7
EXPERIMENT_NAME = f'maze_224_{GRID_SIZE}'
DATASET_LENGTH  = 1000
...
# Augmentation (uncomment to enable)
# AUG_PROB       = 0.5
# ROTATION_LIMIT = 180
...
train_dataset = BinaryMazeDataset(
...
valid_dataset = BinaryMazeDataset(
    transform=valid_transform,
    shape=IMG_SIZE,
    grid_size=GRID_SIZE,
    length=DATASET_LENGTH // 3,
    seed=42,
)
