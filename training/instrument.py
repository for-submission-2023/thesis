...
from datasets import InstrumentDataset
...
BASE = '/home/litisnouman/Desktop/Thesis_18_02_26/datasets/Instrument/MedAI_2021_Instrument_Segmentation_Development_Dataset'
...
train_dataset = InstrumentDataset(train_images, train_masks, transform=train_transform, return_path=False)
valid_dataset = InstrumentDataset(valid_images, valid_masks, transform=valid_transform, return_path=False)
